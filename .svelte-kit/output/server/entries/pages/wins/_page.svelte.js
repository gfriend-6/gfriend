...
const Line = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  Chart$2.register(LineController);
  let { chart: chart2 = null } = $$props;
  let props;
  let baseChartRef;
  useForwardEvents();
...
const Chart = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  Chart$2.register(Title, Tooltip, Legend, LineElement, LinearScale, PointElement, CategoryScale);
  const options = {
    responsive: true,
    interaction: false,
    scales: {
  ...
  return `${validate_component(Card, "Card").$$render($$result, { size: "xxl" }, {}, {
    default: () => {
      return `${validate_component(Line, "Line").$$render($$result, { data: chart, options }, {}, {})}`;
    }
  })}`;
});
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<section class="svelte-7w87tm"><p data-svelte-h="svelte-1w46p3a">This is incomplete i only added gfriend and the highest preforming gg so far</p> ${validate_component(Chart, "Chart").$$render($$result, {}, {}, {})} </section>`;
});
export {
  Page as default
};
